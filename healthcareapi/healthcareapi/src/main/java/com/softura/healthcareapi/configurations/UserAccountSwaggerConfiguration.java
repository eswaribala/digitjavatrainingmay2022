...
public class UserAccountSwaggerConfiguration {
    ...
    public Docket api10Docket() {
        return new Docket(DocumentationType.SWAGGER_2)
        		.groupName("useraccount-api-1.0")
                .select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.softura.healthcareapi"))
                .paths(PathSelectors.regex("/userAccounts/v1.0.*"))
                .build()
                .apiInfo(getApiInfo())
