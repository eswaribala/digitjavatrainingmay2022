...
import com.softura.healthcareapi.configurations.JwtUtil;
import com.softura.healthcareapi.dtos.JwtRequest;
import com.softura.healthcareapi.dtos.JwtResponse;
import com.softura.healthcareapi.exceptions.DisabledUserException;
import com.softura.healthcareapi.exceptions.InvalidUserCredentialsException;
...
import com.softura.healthcareapi.services.UserAuthService;
...
public class JwtRestController {
	...
	@PostMapping("/signup")
	public ResponseEntity<String> signup(@RequestBody UserAccount user) {
		System.out.print(user.getUserName());
		System.out.print(user.getPassword());
		System.out.print(user.getRoles());
		UserAccount userObj = userAuthService.getUserByUsername(user.getUserName());
